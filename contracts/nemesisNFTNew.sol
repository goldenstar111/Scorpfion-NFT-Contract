...
contract NemesisToken is ERC721 {
    ...
    constructor() ERC721("Nemesis" , "NEM"){
    ...
    function createItemOwner(string memory uri) public returns (uint256){
     ...
     function createItem(string memory uri) public payable returns (uint256){
        int256 data = getThePrice();
         uint256 price = uint256(data);
         price = price.mul(20);
         require(price <= msg.value , 'Please Send Funds More or equal to Twenty Dollar');
